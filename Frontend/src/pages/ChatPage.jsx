...
// import { FiSun, FiMoon, FiLogOut, FiUser, FiPlus, FiTrash2, FiMenu } from "react-icons/fi";
...
// } else {
//   // Otherwise, update unique list
//   setReferences((prev) => {
//     const all = [...prev, ...newRefs];
//     const unique = Array.from(new Map(all.map((r) => [r.source || JSON.stringify(r), r])).values());
//     return unique;
//   });
// }
...
//       if (currentSessionId) {
//         setChatHistory((prev) => prev.map((s) => (s.id === currentSessionId ? updatedSession : s)));
//       } else {
...
//             </button>
//             <h1 className="text-lg font-semibold flex items-center gap-2">🧠 BrainyDocs</h1>
//           </div>

//           <div className="flex items-center gap-3 relative">
//             <button
//               onClick={handleNewChat}
//               className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 px-3 py-2 rounded-lg text-sm text-white"
//             >
...
//             >
//               <button className="p-2 rounded-lg bg-gray-300 dark:bg-gray-800 hover:bg-gray-400 dark:hover:bg-gray-700">
//                 {user?.name || "User"}
//               </button>
//               {showUserMenu && (
//                 <div className="absolute right-0 mt-2 w-40 bg-gray-200 dark:bg-gray-800 rounded-lg shadow-lg">
//                   <button className="w-full px-4 py-2 text-left hover:bg-gray-300 dark:hover:bg-gray-700 flex items-center gap-2">
//                     <FiUser /> Profile
//                   </button>
//                   <button
//                     onClick={logout}
